...
class AdminAssets {
    ...
    public function enqueue( string $hook_suffix ): void {
        ...
        $admin_scripts = [
            ...
            'nozule-admin-forecasting'      => 'forecasting.js',
            'nozule-admin-loyalty'          => 'loyalty.js',
        ...
        wp_localize_script( 'nozule-api', 'NozuleAdmin', [
            ...
            'capabilities' => [
                ...
                'manage_housekeeping' => current_user_can( 'nzl_manage_housekeeping' ),
                'manage_billing'      => current_user_can( 'nzl_manage_billing' ),
                'manage_pos'          => current_user_can( 'nzl_manage_pos' ),
                'manage_messaging'    => current_user_can( 'nzl_manage_messaging' ),
            ],
        ] );
    }
