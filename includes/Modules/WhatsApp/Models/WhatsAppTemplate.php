 ...
 *
 * Represents a reusable WhatsApp message template with bilingual
 * support (EN/AR) and variable placeholder substitution.
 *
 * @property int         $id
 ...
 * @property string      $body           English body text.
 * @property string|null $body_ar        Arabic body text.
...
class WhatsAppTemplate extends BaseModel {
	...
	/**
	 * Get all recognised trigger events for WhatsApp messages.
	 *
	 * @return string[]
	 */
