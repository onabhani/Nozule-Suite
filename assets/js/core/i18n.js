...
var NozuleI18n = (function () {
    ...
    var translations = {
        en: {
            ...
            'failed_load_member': 'Failed to load member',
            'tx_earn': 'Earn',
            'tx_redeem': 'Redeem',
            'tx_adjust': 'Adjust',
            'reward_discount': 'Discount',
            'reward_free_night': 'Free Night',
            'reward_upgrade': 'Room Upgrade',
            'reward_amenity': 'Amenity',
        ...
        ar: {
            ...
            'failed_load_members': 'فشل تحميل الأعضاء',
            'failed_load_tiers': 'فشل تحميل المستويات',
            'failed_load_rewards': 'فشل تحميل المكافآت',
            'failed_load_stats': 'فشل تحميل الإحصائيات',
            'failed_load_member': 'فشل تحميل بيانات العضو',
            'tx_earn': 'كسب',
            'tx_redeem': 'استبدال',
            'tx_adjust': 'تعديل',
            'reward_discount': 'خصم',
            'reward_free_night': 'ليلة مجانية',
            'reward_upgrade': 'ترقية الغرفة',
            'reward_amenity': 'مرفق',
